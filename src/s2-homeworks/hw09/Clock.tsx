...
function Clock() {
    ...
    const stringTime = new Intl.DateTimeFormat("ru", {
        ...
        minute: "numeric",
        second: "numeric"
    }).format(date).toString() || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    const stringDate = new Date().toLocaleDateString('eng') || <br/>

    // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
    // день недели на английском, месяц на английском (https://learn.javascript.ru/intl#intl-datetimeformat)
    // let options:string = {weekday: 'long'};
    const stringDay = new Intl.DateTimeFormat("eng", {
        weekday: "long"
    }).format(date).toString() || <br/> // пишут студенты
